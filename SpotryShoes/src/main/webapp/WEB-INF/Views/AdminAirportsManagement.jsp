 ...
 <section class="container-fluid bg">
        <section class="row justify-content-center">
	         <div class="w3-display-centre w3-text-white" style="padding:28px">
	            <span class="w3-large">FlyAway Admin Airport Management</span><br>	            
	        </div>
            <div class="row">
                <div class="col">
                    <h2 align="center" style="color:whitesmoke;"><b>Airport Details</b></h2>
                    <br>
                </div>
            </div>
                ...
                <form  method="post" class="form-container" style="color:whitesmoke;" >
	                <table border ="1">
		                ...
		                <c:forEach items ="${airportList}" var = "airport">
		    				<tr>
		    					<td><c:out value="${airport.aiportId}" /></td>
		      					<td><c:out value="${airport.airportCode}" /></td>
		      					<td><c:out value="${airport.airportName}" /></td>
		      					<td><c:out value="${airport.cityName}" /></td>
		      					<td><c:out value="${airport.countryName}" /></td>
