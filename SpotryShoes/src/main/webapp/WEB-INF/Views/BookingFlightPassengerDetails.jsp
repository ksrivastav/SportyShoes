...
<div class="w3-bar w3-white w3-card" id="myNavbar">
 ...
 <section class="container-fluid bg">
        <section class="row justify-content-center">
                ...
                <form action="/FlyawayWebApp/bookFlight" method="post" class="form-container" style="color:whitesmoke;">
	                <table border ="1">
		                <tr><th>
		    				...
		    				<tr>
		    					<td><c:out value="${selectedAvailableFlightsData.flightId}"/></td>
		      					<td><c:out value="${selectedAvailableFlightsData.flightNumber}" /></td>
		      					<td><c:out value="${selectedAvailableFlightsData.localDepartureDateTime}" /></td>
		      					<td><c:out value="${selectedAvailableFlightsData.localArrivalDateTime}" /></td>		      						      				
		      					<td><c:out value="${selectedAvailableFlightsData.depAirportName}" /></td>
		      					<td><c:out value="${selectedAvailableFlightsData.depCity}" /></td>
		      					<td><c:out value="${selectedAvailableFlightsData.arrAirportName}" /></td>
		      					<td><c:out value="${selectedAvailableFlightsData.arrCity}" /></td>		      							      				
		    				</tr>
            ...
            <section class="col-sm-6 col-md-3">
                <form action="/FlyawayWebApp/createReservation" method="post" class="form-container" style="color:whitesmoke;"   modelAttribute="passenger2" >
	                <table border ="1">
		                <tr><th>
		                	</th>			                
			                <th>
	                   ...
	                   <table border ="1">
		                <tr><th>
		    				...
		    				<tr>
		    					...
		    					<td>
		    						<select class="form-control" id="selectPrefix" name="Card Type" >
		      					...
		      					<td>
		      						<input type="text" name = "CardNumber" id="inputCardNumber" class="btn btn-success btn-block" placeholder="	Card Number"/>
								</td>
		      					<td>
		      						<input type="text" name = "CardHolderName" id="inputCardHolderName" class="btn btn-success btn-block" placeholder="Card Holder Name"/>
								</td>
		      					<td>
		      						<input type="text" name = "ExpiryDate" id="inputExpiryDate" class="btn btn-success btn-block" placeholder="ExpiryDate"/>
								</td>		      						      				
		      					<td>
		      					   <input type="text" name = "CVV" id="inputCVV" class="btn btn-success btn-block" placeholder="CVV"/>
		      					</td>		      							      							      				
		    				</tr>
